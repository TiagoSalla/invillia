            ...
            <div>
                ...
                <form onSubmit={this.submit}>
                    ...
                    <select name="personId" onChange={this.change}>
                        ...
                        {this.state.people.map(person => <option key={person.id} value={person.id}>{person.name}</option>)}
                    </select>

                    <Field name="number" label="Account Number" value={account.number} errors={errors["number"]} onChange={this.change} />

                    <Field name="agency" label="Agency" value={account.agency} errors={errors["agency"]} onChange={this.change} />
                    ...
                    <Field name="specialLimit" label="Special Limit" value={account.specialLimit} errors={errors["specialLimit"]} onChange={this.change} />
